...
project_path = 'Documents/DIDATTICA_2016/grafica/progetti/marsiglia/model/'

""" Input pilotis (struttura-base) """

filename = project_path + "struttura-base.svg"
...
filename = project_path + 'grid.svg'
...
filename = project_path + "entree.lines"
lines = lines2lines(filename)
#VIEW(STRUCT(AA(POLYLINE)(lines)))
