...
if __name__=="__main__":
	lines2D = [
		[[1.0, 2.359223927328458e-16], [0.9999999999999998, 1.1000000000000003]],
		[[1.0999999999999999, 1.1000000000000003],
		[0.9999999999999998, 1.1000000000000003]],
		[[0.0, 0.0], [-2.3592239273284573e-17, 0.1]],
		[[1.1, 2.595146320061304e-16], [1.1, 0.10000000000000027]],
		[[1.1, 2.595146320061304e-16], [1.0999999999999999, 1.1000000000000003]],
		[[1.1, 0.10000000000000027], [-2.3592239273284573e-17, 0.1]],
		[[0.0, 0.0], [1.1, 2.595146320061304e-16]],
		[[1.1, 2.595146320061304e-16], [1.0, 2.359223927328458e-16]]]

	V,EV = bruteForceIntersect(lines2D)
	V,polygons,EV = larPair2Triple((V,EV))
	FV = AA(list)(AA(set)(AA(CAT)(polygons)))

	submodel = STRUCT(MKPOLS((V,EV)))
	VV = AA(LIST)(range(len(V)))
	VIEW(larModelNumbering(1,1,1)(V,[VV,EV,FV],submodel,0.35))
