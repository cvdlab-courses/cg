...
floor2 = [FW[k]  for k in [11,12,14,16]]
...
interior = STRUCT(MKPOLS((W,[FW[k]  for k in [11,12]])))
c = MED([1,2])(interior)
...
twoDuplex,T(3)(h),lowFloor,T(3)(h),upFloor,T(3)(h*1.1),base])
...
xyzframe = MAP(CONS([S1,S3,S2]))(PROD([xyframe,Q(1.6)]))
VIEW(xyzframe)
...
building = STRUCT( [COLOR(YELLOW)(STRUCT(MKPOLS(frame))), T(2)(-3.3*1.5)(xyzframe),
